...
public class ChipsInput extends ScrollViewMaxHeight {
    ...
    private void init(AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            try {
                ...
                mTextSize = a.getDimensionPixelSize(R.styleable.ChipsInput_textSize, getResources().getDimensionPixelSize(R.dimen.input_text_size));
        ...
        setWindowCallback(true);
    }

    public void setWindowCallback(boolean enabled) {
        ...
        activity.getWindow().setCallback(new MyWindowCallback(mCallBack, activity, enabled));
    }
    ...
    public void setClearTextAfterChipAdd(boolean clearTextAfterChipAdd) {
        mChipsAdapter.setClearTextAfterChipAdd(clearTextAfterChipAdd);
    }
    ...
    public void afterTextChanged(CharSequence text) {
        if(mChipsListener != null) {
            for (ChipsListener chipsListener : mChipsListenerList) {
                chipsListener.afterTextChanged(text);
            }
        }
    }
